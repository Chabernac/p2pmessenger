...
public class ImageLoader {
  ...
  private TransparantImageProducer myProducer = null;

  public ImageLoader(){
    myProducer = new TransparantImageProducer();
    myProducer.addColor(Color.white);
  }
  ...
  public BufferedImage loadImage(iResource aResource, boolean isTransparent) throws IOException{
    ...
    if(isTransparent){
      theImage = Tools.makeTransparent(theImage, new Color[]{Color.white});
    } 
