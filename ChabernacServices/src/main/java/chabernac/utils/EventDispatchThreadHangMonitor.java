...
public final class EventDispatchThreadHangMonitor extends EventQueue {
    private static Logger LOGGER = Logger.getLogger(EventDispatchThreadHangMonitor.class);
    ...
    private static class DispatchInfo {
        ...
        private void examineHang() {
            ...
            LOGGER.error("(hang #" + hangNumber + ") event dispatch thread stuck processing event for " + timeSoFar() + " ms:" + stackTrace);
            checkForDeadlock();
        }
        ...
        public void dispose() {
            if (lastReportedStack != null) {
                LOGGER.error("(hang #" + hangNumber + ") event dispatch thread unstuck after " + timeSoFar() + " ms.");
            }
        }
    }
    ...
    private static void checkForDeadlock() {
        ...
        LOGGER.error( "deadlock detected involving the following threads:");
        ThreadInfo[] threadInfos = threadBean.getThreadInfo(threadIds, Integer.MAX_VALUE);
        for (ThreadInfo info : threadInfos) {
          LOGGER.error( "Thread #" + info.getThreadId() + " " + info.getThreadName() + 
