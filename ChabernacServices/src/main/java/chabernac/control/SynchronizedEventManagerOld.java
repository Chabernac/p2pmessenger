 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class SynchronizedEventManagerOld implements Runnable{
  private static final Logger LOGGER = Logger.getLogger(SynchronizedEventManagerOld.class);
	...
	public SynchronizedEventManagerOld(long aCycleTime){
