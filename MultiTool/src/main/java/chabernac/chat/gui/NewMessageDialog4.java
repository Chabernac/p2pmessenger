...
public class NewMessageDialog4 extends TrueDialog implements iObjectProcessor{
  private static Logger logger = Logger.getLogger(NewMessageDialog4.class);
...
//	private boolean closing = false;
  ...
  private static NewMessageDialog4 instance = null;

  private NewMessageDialog4(ChatMediator aMediator){
...
//		myText.setToolTipText("r = reply, a = reply all, c = chat");
    ...
    myQueueReader = new TriggeredQueueReader(myQueue, this);
    myQueueReader.setThreads(1);
  }
  ...
  private void setTitle(){
    if(myMessage != null){
      ...
      if(myQueueReader.getUnProcessedObjects() > 1){
        theTitle += " (+" + (myQueueReader.getUnProcessedObjects() - 1) + ")";
      }
...
//				myContentPanel.requestFocus();
  ...
  public static void creatIntance(ChatMediator aMediator){
    if(instance == null) instance = new NewMessageDialog4(aMediator);
  }
