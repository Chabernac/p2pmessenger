...
public class Task extends DefaultMutableTreeNode implements Comparable, Iterable {
    ...
    /*
     * public TaskContainer getSubTasks(){ return subTasks; }
     */
    ...
    public String toString() {
        return getName();
        /*
         * String theString = ""; theString += "Task name: " + getFullName() + "\n"; if(subTasks.size() > 0){ theString +=
         * " This task has subtasks: " + "\n"; for(int i=0;i<subTasks.size();i++){ theString += subTasks.get(i).toString(); } } else
         * { theString += " Periods worked on task: " + "\n"; for(int i=0;i<periods.size();i++){ theString +=
         * periods.get(i).toString(); } } return theString;
         */
    }
    ...
    public int getSequenceIndicator() {
        ...
        if ( getDueTime() > 0 && theRemainingTime < getRemainingTime() )
            theIndicator = "1";
        else
            theIndicator = "0";
        ...
        if ( getDueTime() <= 0 )
            theIndicator += "000";
        else if ( theRemainingTime < getRemainingTime() )
            theIndicator += "100";
        else {
            theIndicator += "0";
