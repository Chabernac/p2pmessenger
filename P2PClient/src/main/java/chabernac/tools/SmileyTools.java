...
public class SmileyTools {
    ...
    static {
        ...
        SMILEYS.put( "\\:\\-\\)", SmileyTools.class.getResource( "/images/status_BUSY.gif" ).toString() );
    ...
    public static String replaceSmileys( String aString ) {
        ...
        aString = aString.replaceAll( "\\[smiley:(\\p{Alpha}+)(\\d{3})\\]",
                "http://www.freewebthings.net/smileys/images/$1/$1-smiley-$2.gif" );
        return aString;
    }
}
