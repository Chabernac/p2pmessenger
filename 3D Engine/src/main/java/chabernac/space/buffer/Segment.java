...
public class Segment {
	...
	private void calculateRicos() {
		...
		udiff = theTextureEndPoint.x - theTextureStartPoint.x;
		vdiff = theTextureEndPoint.y - theTextureStartPoint.y;
	...
	public void next(){
		...
		int red= (int) (l * ( ( color & 0x00FFFFFF ) >> 16 ));
		int green= (int) (l * ( ( color & 0x0000FFFF ) >> 8 ));
		int blue= (int) (l * ( ( color & 0x000000FF ) >> 0 ));
		...
		c = new Color(red, green, blue).getRGB();
	}
