...
public class Polygon{
  ...
  public void done(){
    ...
    //myTexture = new Texture(w[0].myPoint, new Point3D(w[0].myPoint.x + 1, w[0].myPoint.y, w[0].myPoint.z), new Point3D(w[0].myPoint.x, w[0].myPoint.y + 1, w[0].myPoint.z), null);
    ...
    try {
    	...
    	GVector theYVector = theXVector.produkt(myNormalVector);
    	theXVector.normalize();
    	theYVector.normalize();
    	
		myTexture = new Texture2(w[0].myPoint, theXVector, theYVector, "metal005" );
		for(int i=0;i<w.length;i++){
			w[i].myTextureCoordinate = myTexture.getTextureCoordinate(w[i].myPoint);
		}
	} catch (IOException e) {
    ...
    for(int i=0;i<myCamSize;i++){
      ...
      if(dist1 < 0 && dist2 < 0){}
        ...
        theTempVertexes[j] = new Vertex(new Point3D(c[i].myPoint.x + (c[ii].myPoint.x - c[i].myPoint.x) * distratio,
                                        ...
                                        new Point2D(c[i].myTextureCoordinate.x + (c[ii].myTextureCoordinate.x - c[i].myTextureCoordinate.x) * distratio,
                                        			c[i].myTextureCoordinate.y + (c[ii].myTextureCoordinate.y - c[i].myTextureCoordinate.y) * distratio));
        ...
        theTempVertexes[j] = new Vertex(new Point3D(c[ii].myPoint.x + (c[i].myPoint.x - c[ii].myPoint.x) * distratio,
                                        ...
                                        new Point2D(c[ii].myTextureCoordinate.x + (c[i].myTextureCoordinate.x - c[ii].myTextureCoordinate.x) * distratio,
                                        			c[ii].myTextureCoordinate.x + (c[i].myTextureCoordinate.x - c[ii].myTextureCoordinate.x) * distratio));
