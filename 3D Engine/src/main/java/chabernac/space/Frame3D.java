...
public class Frame3D extends JFrame implements iSynchronizedEvent{
  ...
  private void startFullScreen(){
	...
	Debug.log(this,"Width: " + theCurrentMode.getWidth()+  " Height: " + theCurrentMode.getHeight()+  " depth: " + theCurrentMode.getBitDepth() + " refresh rate: " + theCurrentMode.getRefreshRate());
