...
public class Command3dFactory {
	public static KeyCommand strafeLeft(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
		return new CameraMoveCommand("Strafe left", aManager, aCamera, new Camera(new Point3D(-aSpeed, 0, 0), new Rotation(0,0,0), 1F));
	}
	
	public static KeyCommand strafeRight(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
			return new CameraMoveCommand("Strafe right", aManager, aCamera, new Camera(new Point3D(aSpeed, 0, 0), new Rotation(0,0,0), 1F));
	}
	
	public static KeyCommand forward(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
			return new CameraMoveCommand("Forward", aManager, aCamera, new Camera(new Point3D(0, 0, aSpeed), new Rotation(0,0,0), 1F));
	}
	
	public static KeyCommand backward(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
			return new CameraMoveCommand("Backwards", aManager, aCamera, new Camera(new Point3D(0, 0, -aSpeed), new Rotation(0,0,0), 1F));
	}
	
	public static KeyCommand strafeUp(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
			return new CameraMoveCommand("Strafe up", aManager, aCamera, new Camera(new Point3D(0, aSpeed, 0), new Rotation(0,0,0), 1F));
	}
	
	public static KeyCommand strafeDown(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
			return new CameraMoveCommand("Strafe down", aManager, aCamera, new Camera(new Point3D(0, -aSpeed, 0), new Rotation(0,0,0), 1F));
	}	
	
	public static KeyCommand left(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
			return new CameraMoveCommand("Left", aManager, aCamera, new Camera(new Point3D(0, 0, 0), new Rotation(0,0,+aSpeed), 1F));
	}
	
	public static KeyCommand right(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
	...
	public static KeyCommand rollRight(SynchronizedEventManager aManager, Camera aCamera, double aSpeed) throws MatrixException{
