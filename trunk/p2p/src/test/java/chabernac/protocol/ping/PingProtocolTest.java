...
public class PingProtocolTest extends TestCase {
  public void testPingProtocol(){
    ...
    assertEquals( Response.PONG.name(), new String(theProtocol.handleCommand( "0", null, Command.PING.name()) ));
    assertEquals( Response.UNKNOWN_COMMAND.name(), new String(theProtocol.handleCommand( "0", null, "somtehing") ));
