...
import chabernac.jna.unix.common.X11;
import chabernac.jna.unix.common.X11.XVisualInfo;
import chabernac.jna.unix.common.X11.Xext;
import chabernac.jna.unix.common.X11.Xrender.XRenderPictFormat;
import chabernac.jna.win.common.GDI32;
import chabernac.jna.win.common.User32;
import chabernac.jna.win.common.GDI32.BITMAPINFO;
import chabernac.jna.win.common.User32.BLENDFUNCTION;
import chabernac.jna.win.common.User32.POINT;
import chabernac.jna.win.common.User32.SIZE;
import chabernac.jna.win.common.W32API.HANDLE;
import chabernac.jna.win.common.W32API.HBITMAP;
import chabernac.jna.win.common.W32API.HDC;
import chabernac.jna.win.common.W32API.HRGN;
    ...
    private static class W32WindowUtils extends NativeWindowUtils {
        ...
        private class W32RepaintTrigger extends RepaintTrigger {
            ...
            public void update() {
                ...
                int w = win.getWidth();
                int h = win.getHeight();
                HDC screenDC = (HDC) user.GetDC(null);
                ...
                try {
                    ...
                    blend.SourceConstantAlpha = level;
                    blend.AlphaFormat = User32.AC_SRC_ALPHA;
                    user.UpdateLayeredWindow(hWnd, screenDC.getPointer(), loc, size, memDC.getPointer(),
                                             srcLoc, 0, blend, User32.ULW_ALPHA);
                }
                finally {
                    user.ReleaseDC(null, screenDC.getPointer());
                    if (hBitmap != null) {
            ...
            whenDisplayable(w, new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        user.SetWindowRgn(hWnd, result.getPointer(), true);
                    }
                    finally {
