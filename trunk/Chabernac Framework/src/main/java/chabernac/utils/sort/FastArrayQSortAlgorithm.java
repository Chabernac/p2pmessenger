...
public class FastArrayQSortAlgorithm
{
        ...
        */
        private void QuickSort(Comparable[] a, int l, int r) throws Exception
   {
        int M = 4;
        int i;
        int j;
        ...
        {
                i = (r+l)/2;
                if (a[l].compareTo(a[i]) > 0) swap(a,l,i);     // Tri-Median Methode!
                if (a[l].compareTo(a[r]) > 0) swap(a,l,r);
                if (a[i].compareTo(a[r]) > 0) swap(a,i,r);
        ...
        private void InsertionSort(Comparable[] a, int lo0, int hi0) throws Exception
        {
                int i;
                int j;
                Comparable v;
