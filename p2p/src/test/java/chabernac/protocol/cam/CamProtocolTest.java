...
public class CamProtocolTest extends AbstractProtocolTest {
  ...
  public void testSendPacket() throws ProtocolException, InterruptedException, MessageException, UnknownPeerException, PacketProtocolException{
    ...
    try{
      ...
      CamProtocol theCamProtocol1 = new CamProtocol( thePacketProtocol1 );
      CamProtocol theCamProtocol2 = new CamProtocol( thePacketProtocol2 );
      
      CamPanel thePanel = new CamPanel();
      ...
      theCamProtocol1.addCamListener( thePanel );
      theCamProtocol1.requestCapture( "2" );
