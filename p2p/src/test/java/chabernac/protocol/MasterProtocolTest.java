...
public class MasterProtocolTest extends TestCase {
  ...
  public void testMasterProtocol() throws ProtocolException{
    ...
    assertEquals( PingProtocol.Response.PONG.name(), new String(theMasterProtocol.handleCommand( "0", null, PingProtocol.ID + "ping") ));
    assertEquals( PingProtocol.Response.UNKNOWN_COMMAND.name(), new String(theMasterProtocol.handleCommand( "0", null, PingProtocol.ID + "somtehing") ));
    
//    assertEquals( "Master protocol" , theMasterProtocol.getDescription());
   
    String theResult = new String(theMasterProtocol.handleCommand( "0", null, ListProtocol.ID + "protocols" ));
