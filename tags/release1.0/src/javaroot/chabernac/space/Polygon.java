...
public class Polygon implements iTranslatable{
  ...
  public void done(){
    ...
    if(myTextureName != null) calculateTexturePoints();
  ...
  */
  ...
  public void translate(iTransformator aTransformator) throws PolygonException, MatrixException{
    ...
    if(myNormalVector == null)  calculateNormalVector();
    //TODO shoud this not be if else?
    else myNormalVector = aTransformator.transform(myNormalVector);
      ...
      if(dist1 < 0 && dist2 < 0){}
        ...
        theTempVertexes[j] = new Vertex(new Point3D(c[ii].myPoint.x + (c[i].myPoint.x - c[ii].myPoint.x) * distratio,
            ...
            new Point2D(c[ii].myTextureCoordinate.x + (c[i].myTextureCoordinate.x - c[ii].myTextureCoordinate.x) * distratio,
                c[ii].myTextureCoordinate.y + (c[i].myTextureCoordinate.y - c[ii].myTextureCoordinate.y) * distratio),
