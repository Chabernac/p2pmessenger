...
public class ScreenFrustrum extends Frustrum{
  ...
  public void createPlanes(){
    ...
    //right plane
    addPlane(new Plane(new GVector(-myEyePoint.z,0,(float)(myScreenDimension.getWidth() / 2)),theEyePoint));
    //top plane
    addPlane(new Plane(new GVector(0, -myEyePoint.z,(float)(myScreenDimension.getHeight() / 2)),theEyePoint));
    //bottom plane
    addPlane(new Plane(new GVector(0, myEyePoint.z,(float)(myScreenDimension.getHeight() / 2)),theEyePoint));
  }
